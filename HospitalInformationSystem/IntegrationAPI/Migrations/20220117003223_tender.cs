...
namespace IntegrationAPI.Migrations
{
    public partial class tender : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Pharmacies",
                columns: new[] { "Id", "ApiKey", "Base64Image", "ComunicateWithGrpc", "EmailAddress", "Name", "Notes", "Port", "Sftp", "Url" },
                values: new object[,]
                {
                    { 1L, "fds15d4fs6", null, false, "psworganisation8+Apoteka1@outlook.com", "Apoteka1", null, "18013", false, "http://localhost" },
                    { 2L, "fds15d4fs6", null, true, "psworganisation8+Apoteka2@outlook.com", "Apoteka2", null, "4111", true, "localhost" },
                    { 3L, "fds15d4fs6", null, true, "psworganisation8+Apoteka3@outlook.com", "Apoteka3", null, "18013", true, "http://localhost" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "MedicationName", "PharmacyOfferId", "Price", "Quantity" },
                values: new object[,]
                {
