...
namespace IntegrationClassLib.Parthership.Service
{
    public class EmailService
    {
            ...
            IPharmacyRepository pharmacyRepository)
        {
            ...
            /*emailCredentials = new NetworkCredential("psworganisation8@gmail.com", "ftnPswOrganisation8");
            smtp = new SmtpClient();
            smtp.Port = 587;
            ...
            emailCredentials = new NetworkCredential("psworganisation8@outlook.com", "pswFtnOrganisation8");
            smtp = new SmtpClient();
            smtp.Port = 587;
