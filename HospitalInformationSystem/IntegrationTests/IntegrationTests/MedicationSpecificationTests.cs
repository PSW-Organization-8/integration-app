...
namespace IntegrationTests
{
    public class MedicationSpecificationTests
    {
        ...
        public void SuccessSaveMedicationSpecification()
        {
            ...
            NotificationDTO retVal = medicationSpecificationController.MakeReport(new MedicationSpecificationDTO { PharmacyName = "Apoteka1", MedicationName="Ventolin" });

            retVal.FileName.ShouldNotBe(" ");
        }
